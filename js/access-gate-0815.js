...
(function () {
  ...
  mask.innerHTML =
    '<div class="cc-card">' +
      ...
      '<a class="cc-guest" href="/guestbook.html">无需密码 · 直接进入留言板 →</a>' +
  ...
  style.textContent =
    ...
    '#cc-gate .cc-guest{display:block;margin-top:14px;font-size:13px;color:#8A8A93;text-decoration:none;cursor:pointer}' +
    '#cc-gate .cc-guest:hover{color:#1D1D1F;text-decoration:underline}' +
